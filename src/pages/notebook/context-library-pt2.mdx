...
### 2.1 Marvel's Public Context Libraries
...
### 2.2 What the Wiki Doesn't Contain
...
### 2.3 The Five-Dimension Requirement

The Marvel Wiki gives intuition. The five dimensions give rigor.

Section 2.1 showed what the wiki captures beautifully: identity, affiliations, relationships, history, powers. Section 2.2 showed what it doesn't: the editorial direction, strategic choices, and institutional memory that guide aligned decisions.
