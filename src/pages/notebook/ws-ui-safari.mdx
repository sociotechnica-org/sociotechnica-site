...
<NotebookArticleHeader
  ...
  prevNote={{ id: "WS001", title: "Technical Foundations", url: "/notebook/ws-tech-foundations" }}
  nextNote={{ id: "WS003", title: "Innovation Session Planning using AI", url: "/notebook/planning-a-collab" }}
/>
