...
<NotebookArticleHeader
  ...
  prevNote={{
    ...
    url: "/notebook/worksquared-to-lifebuild",
  }}
  nextNote={{
    id: "WS009",
...
Thanks to Johannes Schickling for sending me down this path last July with [this tweet](https://x.com/schickling/status/1940368715297534356) and for the many conversations since:
