---
title: "Protocol Adoption | SocioTechnica"
...
<div class="p-5 mb-5 border-2 bg-slate-100">
  <p class="italic text-neutral-600">
    <b class="font-semibold">Work in Progress:</b> These are a set of working
    notes about how to drive adoption of new protocols.
  </p>
</div>
